...
import { Wifi, AirVent, ShowerHead, CookingPot, Waves, Sun, WashingMachine, ParkingCircle, Mountain, BedDouble, Layers, KeyRound, Bath, ChefHat, Languages } from 'lucide-react'
